...
urlpatterns = [
    ...
    path('create_exam_with_fee/', views.create_exam_with_fee, name='create_exam_with_fee'), 
   ...
   # path('get-subject-teacher/', views.get_subject_teacher, name='get_subject_teacher'),   
    ...
    #path('get_exam_details/', views.get_exam_details, name='get_exam_details'),
    path('exam/<int:exam_id>/mark-over/', views.mark_exam_over, name='mark_exam_over'),
   ...
   path('student_ranking_view/', views.student_ranking_view, name='student_ranking_view'),
