...
EMAIL_HOST = 'mail.e2esolutionsbd.com'         # Your SMTP mail server
EMAIL_PORT = 465                                # Common SMTP port (can be 465 or 587)
#EMAIL_USE_TLS = True                            # Enable TLS (recommended for 587)
EMAIL_USE_SSL = True                          # Use this instead if your port is 465
EMAIL_HOST_USER = 'humayun@e2esolutionsbd.com'  # Your email address
EMAIL_HOST_PASSWORD = 'ArafaT_1234'     # Your email account password
